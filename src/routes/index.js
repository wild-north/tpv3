...
import { profileConnector, loginConnector, initialPageConnector, groupDetailsConnector } from 'connector';
...
const GroupDetailsPage = groupDetailsConnector(pages.GroupDetails);
...
export const AppRouter = () => (
    <Fragment>
        <Switch>
            ...
            <DefaultRoute path={ routes.GROUPS } exact component={ pages.Groups } />

            <DefaultRoute path={ routes.GROUP_DETAILS } component={ GroupDetailsPage } />
